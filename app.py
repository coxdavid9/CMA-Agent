...
with practice:
    ...
    if q is None:
        ...
        if not st.session_state.submitted:
            ...
            st.markdown('**Remember**'); st.markdown(f'<div class="takeaway">{fb["takeaway"]}</div>',unsafe_allow_html=True)
